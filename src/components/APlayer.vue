...
// getTracks()
const tracks = reactive([
  '01_storm_inside_nas_bolshe_net_myzuka',
  'ApostaZiya - ',
  'EPOHA_STRANSTVIJ_-_CHelovek_Iz_ZHeleza_(iPleer.fm)',
  'ESSE - Геральт',
  'Evil Not Alone – Письмо',
  'KIT-I - После дождя',
  'Konstantin_Legostaev-Zabud_svoy_ad_OstKarpov__(mymp3.name)',
  'LIZER - Корабли',
  'Noize MC - Это был Дождь',
  'Wallace_Band - Белоголовый ведьмак',
  'Zebra Dlya Supa - Dorian ',
  'ex-сектор-газа-кладбище-сердец',
  'inexist-читая-сны',
  'АРТЕМ ИВАНОВ - ЕСЛИ БЫ ТЫ ЗНАЛА',
  'Антиллия - Шаман',
  'Астера - Стражник гробниц',
  'Блокада сердца – Пожары и дожди',
  'Жуки - Батарейка',
  'Крылья оригами – Три сердца осьминога',
  'ЛСП_-_Номера',
  'Синтетика 59 - Модная грязь',
  'Смеян Павел (Москва) - Солдат удачи (В. Мазур)',
  'Спасение – Странные сны',
  'Сплин - Скажи, что я ее люблю',
  'Этажность – Погас и остыл',
  'агата-кристи-ураган',
  'александр-иванов-это-был-я',
  'алексеи-понамарев-мы-не-ангелы',
  'ангел-небес-тт-пожар-на-твоем-теле',
